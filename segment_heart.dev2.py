...
#				plt.savefig(out_fig)
	...
	vid_frames = [i for i in heart_changes if i is not None]
	#Make videos
...
#	peaks, _ = find_peaks(x, height = meanX)
	...
	if len(peaks[prominent_peaks]) > 4:
		...
		peak_signal = x[peaks[prominent_peaks]]
